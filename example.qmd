...
However, in order to follow a smoother workflow and reduce any duplication when cloning the file to local platform, it is better to operate Git locally first, and then push to remote repository.
